...
xcopy /E /I /Y skills\spss-studio-mcp-guard "%SKILLS_DIR%\spss-studio-mcp-guard" >nul 2>&1
...
if errorlevel 1 (
    echo [错误] 自动配置失败，请手动执行: spss-studio-mcp configure-claude
    pause
    exit /b 1
)
